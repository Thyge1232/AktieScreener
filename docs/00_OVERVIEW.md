...
*   **[1. Konfiguration og Dataloading](./docs/01_CONFIG_AND_DATA_LOADING.md):** Forklarer, hvordan screeningsprofiler er defineret i JSON, og hvordan den indledende CSV-fil bliver indlæst og renset.
*   **[2. API Klient](./docs/02_API_CLIENT.md):** Detaljerer, hvordan applikationen kommunikerer med eksterne API'er, håndterer rate limits og bruger caching for at optimere ydeevnen.
*   **[3. Screenings-motor](./docs/03_SCREENING_ENGINE.md):** En dybdegående gennemgang af point-beregning, vægtning og den kritiske sektor-normaliseringsalgoritme.
*   **[4. Værdiansættelses-motor](./docs/04_VALUATION_ENGINE.md):** Forklarer den finansielle modellering bag DCF-analysen, WACC-beregning og scenarieanalyse.
*   **[5. UI Implementering](./docs/05_UI_IMPLEMENTATION.md):** Beskriver, hvordan Streamlit bruges til navigation, state management og integration med interaktive AgGrid-tabeller.
*   **[6. Værktøjer og Hjælpefunktioner](./docs/06_UTILITIES.md):** Dækker de understøttende moduler for validering, favoritstyring og mere.